...
require '../../config/database.php';      // Database configuration (ensure this path is correct)
require '../../models/TimeSettings.php'; // Time setting logic (ensure this path is correct)
include '../templates/header.php';      // Page header (ensure this path is correct and the header is properly structured)
...
<body>
    ...
    <?php include '../../views/templates/AI.php'; ?>       <!--  Ensure these files are correctly included and necessary -->
    <?php include '../templates/translate.php'; ?>  <!--  and that their paths are correct. -->
    <?php include '../templates/footer.php'; ?> <!-- Consistent with header.php -->
