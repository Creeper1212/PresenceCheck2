...
<head>
    ...
    <link rel="stylesheet" href="../../../public/assets/css/header_styles.css">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="index.php">
                    <img src="../../../public/assets/images/logo.png" alt="ASB Logo" height="30" class="d-inline-block align-text-top">
                    ASB
                </a>
