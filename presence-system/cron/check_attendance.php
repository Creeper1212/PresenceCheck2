...
if($current_time >= $deadline) {
    ...
    // 5. Trigger ../app/services/AsteriskService.php if no entries found
    if($data['count'] == 0) {
        // Execute ../app/services/AsteriskService.php
        shell_exec('../app/services/AsteriskService.php');
        
        // Optional: Log the event
        error_log("[" . date('Y-m-d H:i:s') . "] No entries found. Triggered ../app/services/AsteriskService.php");
    }
}
?>
